/*Create below Shape class which is abstract abstract class Shape{
...
method, e.g., getShape() method s.draw();}}*/
package question21.abstractexample23;

public class TesrAbstraction1 {
    public static void main(String[] args) {
        Shape s = new Circle1();
        s.draw();
    }
